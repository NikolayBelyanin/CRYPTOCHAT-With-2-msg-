...
class Wallet:
    ...
    def sign_transaction(self, sender, recipient, amount, msg_from, msg_to):
        ...
        h = SHA256.new((str(sender) + str(recipient) +
                        str(amount) + str(msg_from) + str(msg_to)).encode('utf8'))
    ...
    def verify_transaction(transaction):
        ...
        h = SHA256.new((str(transaction.sender) + str(transaction.recipient) +
                        str(transaction.amount) + str(transaction.msg_from) + str(transaction.msg_to)).encode('utf8'))
