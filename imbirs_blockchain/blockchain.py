...
class Blockchain:
            ...
            with open('blockchain-{}.txt'.format(self.node_id), mode='r') as f:
                ...
                for block in blockchain:
                    converted_tx = [Transaction(
                        ...
                        tx['amount'],
                        tx['msg_from'],
                        tx['msg_to']) for tx in block['transactions']]
                    updated_block = Block(
                        block['index'],
                        block['previous_hash'],
                        converted_tx,
    ...
    def add_transaction(self,
        ...
        #     return False
        transaction = Transaction(sender, recipient, signature, amount, msg_from, msg_to)
        ...
        for itx in block['transactions']:
            for opentx in stored_transactions:
                if (opentx.sender == itx['sender'] and
                        ...
                        opentx.msg_from == itx['msg_from'] and
                        opentx.msg_to == itx['msg_to']):
                    try:
